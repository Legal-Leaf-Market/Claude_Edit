...
import { CitationBlock } from "@/components/stompbox/citation"
      ...
      */}
      ...
      <div className="mt-8 space-y-8">
        ...
        <section className="surface p-6">
          ...
          <div className="mt-6">
            <StompLink href={sbHref(base, "/chain")} size="sm" led={false}>
              See the whole chain
            </StompLink>
          </div>
        </section>
            ...
            {siblings.map((sibling) => (
              <li key={sibling.slug}>
                <Link
                  ...
                  className="surface block p-4 transition-colors hover:border-[var(--chrome)]"
                >
